...
// ตั้งรูป preview (จะหา .preview-img ที่มีอยู่และเปลี่ยน src)
...
// โหลด gallery เริ่มต้น
renderImageGallery();
if(images.length > 0 && !preview.querySelector('.preview-img')){
	// ตั้งรูปแรกเป็น preview โดยอัตโนมัติ (ไม่บังคับ)
	setPreviewImage(images[0].data);
}
